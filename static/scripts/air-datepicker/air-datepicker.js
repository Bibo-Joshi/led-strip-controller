!function (e, t) {
    ...
    return function () {
        ...
        class C {
            ...
            _getClassName() {
                ...
                let s = new Date, {
                        selectOtherMonths: a,
                        selectOtherYears: n
                    } = this.opts, {minDate: r, maxDate: h} = this.dp, {day: l} = o(this.date),
            ...
            _isOutOfMinMaxRange() {
                let {minDate: e, maxDate: t} = this.dp, {type: s, date: a} = this, {
                        month: n,
                        year: r,
                        date: h
        ...
        class T {
            ...
            static getDaysDates(e, t) {
                let {viewDate: i, locale: {firstDay: s}} = e, a = h(i), {year: n, month: r} = o(i),
                    l = new Date(n, r, 1), d = new Date(n, r, a), c = l.getDay() - s,
                    u = 6 - d.getDay() + s;
        ...
        class A {
            ...
            focusNextCell(e) {
                let t = this.getInitialFocusDate(), {currentView: s} = this.dp, {
                    days: a,
                    months: n,
                    years: r
                } = i, h = o(t), l = h.year, d = h.month, c = h.date;
                switch (e) {
                    case"ArrowLeft":
        ...
        class B {
            ...
            constructor(e, t) {
                ...
                if (I(this, "viewIndexes", [i.days, i.months, i.years]), I(this, "next", (() => {
                    ...
                    let i, s, {isMobile: a} = r.opts, n = r.$el.getBoundingClientRect(),
                        ...
                        l = r.$el.offsetParent, d = r.$datepicker.getBoundingClientRect(),
                        c = e.split(" "), u = window.scrollY, p = window.scrollX, m = r.opts.offset,
                        v = c[0], g = c[1];
                    ...
                    let {
                        ...
                        $altField: t,
                        locale: {dateFormat: i}
                    } = this, {altFieldDateFormat: s, altField: a} = e;
                    ...
                    let {hours: t, minutes: i} = e, s = new Date, {
                        lastSelectedDate: a,
                        opts: {onSelect: n}
                    } = this, r = a;
                    a || (r = s);
            ...
            formatDate() {
                ...
                let i = t, s = this.locale, a = o(e), n = a.dayPeriod, r = c(e), h = B.replacer,
                    l = {
                        T: e.getTime(),
                        m: a.minutes,
                        mm: a.fullMinutes,
            ...
            getCell(e) {
                ...
                if (!((e = b(e)) instanceof Date)) return;
                let {year: s, month: a, date: n} = o(e), r = `[data-year="${s}"]`,
                    h = `[data-month="${a}"]`, l = {
